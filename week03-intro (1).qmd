...
-   32 rows and 12 columns are in the dataframe.
...
mean(mtcars$mpg) # the $ lets you select z variable/column within df

```

-   Can you find the mean of another variable?

```{r, mean2, warning=FALSE}
